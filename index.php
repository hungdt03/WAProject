                        ...
                        <div class="container">
                                        ...
                                        <div id="demo" class="carousel slide slide-show" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item">
                                                    <img class="image-slider" src="./assets/images/slider2.jpg" alt="Chicago">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="image-slider" src="./assets/images/slider3.png" alt="New York">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="image-slider" src="./assets/images/slider4.jpg" alt="New York">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="image-slider" src="./assets/images/slider5.jpg" alt="New York">
                                                </div>
                                            </div>
                            ...
                            <section class="product__container section-margin-top">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div
                                            class="col col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6 product__container-item">
                                            <div class="product__container-item-wrapper">
                                                <div class="product__container-item-inner">
                                                    ...
                                                    <div class="product-info">
                                                        <a href="#" class="info-link"> Chính hãng</a>
                                                    ...
                                                    <a href="" class="add-product">MUA NGAY</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div
                            ...
                            <section class="product__container section-margin-top">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col col-xl-2 col-lg-3 col-md-4 col-sm-6 product__container-item">
                                            <div class="product__container-item-wrapper">
                                                <a href="#" class="product__container-item-link">
                                                    ...
                                                    <div class="product-info">
                                                        <a href="#" class="info-link">Camera IP Wifi TP-Link Tapo
                                                            C200
